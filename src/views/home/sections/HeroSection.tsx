...
import { HERO_CONTENT, type HomeContent } from '../../../lib/pages/content';
...
export default function Hero({ onStartProcess, onPlayVideo, content = HERO_CONTENT }: HeroProps) {
  return (
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:pt-24 flex flex-col items-center text-center">
          ...
          <EditableText
            ...
            multiline
            className="font-serif-hero uppercase font-normal sm:font-medium text-white tracking-[0.04em] text-[23px] sm:text-[32px] md:text-[38px] lg:text-[43px] leading-[1.18] sm:leading-[1.22] drop-shadow-[0_2px_8px_rgba(0,0,0,0.45)] whitespace-pre-line"
          />
          ...
          <EditableText
            tag="p"
            sectionId="hero-001"
            fieldPath="subheading.hr"
            value={content.subtitle}
            className="font-sans italic text-white/95 text-[12px] sm:text-[13.5px] md:text-[16px] font-[500] mx-auto mt-3 sm:mt-4 leading-[180%] sm:leading-[260%] drop-shadow-[2px_2px_2px_#00000040]"
          />
          ...
          <button
            ...
            className="hero-btn-primary mt-5 sm:mt-6 shadow-sm hover:shadow-md"
          >
            <EditableText sectionId="hero-001" fieldPath="cta.label.hr" value={content.ctaButton} />
          </button>
        </div>
      </div>
    </section>
