  ...
  return (
    <section id="o-marini" className="pt-6 sm:pt-10 pb-16 sm:pb-24 container mx-auto px-4 sm:px-6 md:px-8">
      ...
      <div className="mb-10 sm:mb-14">
        <span className="text-[#2397a6] text-xs sm:text-[13px] font-medium tracking-normal block mb-3">
          O Marini 
        </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col justify-between">
          <div>
            <h3 className="font-serif-hero text-2xl sm:text-[26px] font-medium text-[#2397a6] tracking-wide mb-4 sm:mb-5">
              O Marini
            </h3>

            <p className="text-neutral-600 text-xs sm:text-[13px] md:text-[13.5px] leading-[1.65] font-sans mb-3.5 sm:mb-4">
            ...
            <p className="text-neutral-600 text-xs sm:text-[13px] md:text-[13.5px] leading-[1.65] font-sans mb-4 sm:mb-5">
            ...
            <div className="text-neutral-800 text-xs sm:text-[13px] md:text-[13.5px] font-semibold leading-relaxed font-sans space-y-0.5 mb-5 sm:mb-6">
          ...
          <div className="flex justify-end pt-1">
            <button
              ...
              onClick={onBookCall}
              className="px-5 py-2 sm:py-2.5 rounded-full bg-[#2397a6] hover:bg-[#1f8795] text-white text-xs sm:text-[12.5px] font-medium transition-colors shadow-xs cursor-pointer whitespace-nowrap"
            >
