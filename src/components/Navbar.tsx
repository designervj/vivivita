  ...
  return (
    <header className="sticky top-0 z-40 bg-[#fafafa]/95 backdrop-blur-md transition-all">
      <div className="container mx-auto px-4 sm:px-6 md:px-8 h-16 sm:h-20 flex items-center justify-between">
        {/* Left Navigation */}
        <nav className="hidden md:flex items-center gap-7 sm:gap-9 text-[13.5px] sm:text-[14px] text-[#2c3338]">
          {/* Programi Dropdown */}
          <div
            className="relative"
          ...
          >
            <button
              ...
              className="flex items-center gap-1 hover:text-[#2397a6] transition-colors py-2 cursor-pointer font-normal"
            >
              <span>Programi</span>
            ...
            {isProgramsOpen && (
              <div className="absolute top-full left-0 w-64 bg-white rounded-xl shadow-lg border border-neutral-100 py-2 animate-in fade-in zoom-in-95 duration-150 z-50">
                <button
                  ...
                  className="w-full text-left px-4 py-2.5 text-xs sm:text-sm hover:bg-[#f0f6f7] hover:text-[#2397a6] transition-colors flex items-center justify-between cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-xs sm:text-sm hover:bg-[#f0f6f7] hover:text-[#2397a6] transition-colors cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-xs sm:text-sm hover:bg-[#f0f6f7] hover:text-[#2397a6] transition-colors cursor-pointer font-medium text-[#2397a6]"
                >
                  Premium 1:1 rad
                </button>
              </div>
          ...
          <button
            ...
            className="hover:text-[#2397a6] transition-colors cursor-pointer font-normal"
          >
            O Marini
          </button>
        ...
        {/* Right Navigation */}
        <div className="flex items-center gap-6 sm:gap-7 text-[13.5px] sm:text-[14px] text-[#2c3338]">
          <button
            id="nav-contact-btn"
            onClick={onOpenContact}
            className="flex items-center gap-2 hover:text-[#2397a6] transition-colors cursor-pointer group"
          >
            <Phone className="w-3.5 h-3.5 text-neutral-600 group-hover:text-[#2397a6] transition-colors" />
            <span className="hidden sm:inline font-normal">Kontaktirajte me</span>
          </button>
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1 hover:text-[#2397a6] transition-colors py-1 cursor-pointer font-normal text-xs sm:text-[13.5px]"
            >
            ...
            {isLangOpen && (
              <div className="absolute right-0 top-full mt-2 w-28 bg-white rounded-lg shadow-md border border-neutral-100 py-1.5 z-50">
                <button
                  ...
                  className="w-full text-left px-3 py-1.5 text-xs hover:bg-[#f0f6f7] hover:text-[#2397a6] flex items-center justify-between"
                >
                  <span>Hrvatski</span>
                  {currentLang === 'Hr' && <Check className="w-3.5 h-3.5 text-[#2397a6]" />}
                </button>
                <button
                ...
                >
                  <span>English</span>
                  {currentLang === 'En' && <Check className="w-3.5 h-3.5 text-[#2397a6]" />}
                </button>
              </div>
            )}
          </div>
          ...
          <button
            ...
            className="md:hidden p-2 text-neutral-700 hover:text-[#2397a6]"
            aria-label="Izbornik"
          >
